...
import 'package:latihan1_pplg2/bindings/footballPlayer_binding.dart';
import 'package:latihan1_pplg2/bindings/login_binding.dart';
import 'package:latihan1_pplg2/component/pages/contactPage.dart';
import 'package:latihan1_pplg2/component/pages/example_feauture/example_transform_page.dart';
...
class AppPages {
  static final pages = [
    ...
    GetPage(
      name: AppRoutes.ExampleTransformPage,
